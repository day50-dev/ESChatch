...
parser.add_argument('--method', choices=['llcat', 'simonw'], default='llcat', help='Method to use for LLM interaction')
parser.add_argument('--host', help='host to use')
parser.add_argument('--model', help='model to use')
parser.add_argument('--exec', '-e', default='bash', dest='exec_command', help='Command to execute')
